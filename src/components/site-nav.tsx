...
import logoUrl from "@/assets/outsideatllogo.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-4">
          <h2 className="font-mono text-[10px] text-accent uppercase font-bold">Socials</h2>
        ...
        <div className="space-y-4">
          <h2 className="font-mono text-[10px] text-accent uppercase font-bold">Apply</h2>
          <ul className="font-display text-lg uppercase space-y-1">
            <li>
